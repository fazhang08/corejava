...
public class WCharField extends WordField {
	// default serial number
	private static final long serialVersionUID = 1L;

	// default wide char(byte style)
	private byte[] value;
	 ...
	 * @param field
	 */
	public WCharField(WCharField field) {
		super(field);
	 ...
	 * @param value
	 */
	public WCharField(short columnId, String name, byte[] value) {
		super(Type.WCHAR, columnId, name);
		this.setValue(value);
	}
	...
	public void setValue(byte[] b) {
		if (b == null || b.length < 4 || b.length % 4 != 0) {
			throw new IllegalArgumentException("invalid wchar style!");
		}
	...
	public com.lexst.db.column.Column getDefault(short columnId) {
		if (allowNull) {
			return new com.lexst.db.column.WChar(columnId);
		}
		if (!nullable) {
			return new com.lexst.db.column.WChar(columnId, value);
		}
		return null;
	}
