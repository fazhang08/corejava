...
public class RNChar extends Word {
	 ...
	 * @param id
	 */
	public RNChar(short id) {
		super(Type.RNCHAR, id);
	}
	 ...
	 * @param b
	 */
	public RNChar(short id, short left, short right, byte[] b) {
		this(id);
		this.setLeft(left);
		this.setRight(right);
		this.setValue(b);
	...
	public boolean equals(Object arg) {
		if (arg == null || arg.getClass() != RNChar.class) {
			return false;
		}
