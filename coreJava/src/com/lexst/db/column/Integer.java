...
public class Integer extends Column {
	 ...
	 * * @param id
	 */
	public Integer(short id) {
		super(Type.INTEGER, id);
	}
	 ...
	 * @param num
	 */
	public Integer(short id, int num) {
		this(id);
		this.setValue(num);
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.lexst.db.column.Column#build(java.io.ByteArrayOutputStream,
