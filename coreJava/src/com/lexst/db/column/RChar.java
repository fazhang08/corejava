...
public class RChar extends Word {
	 ...
	 * @param b
	 */
	public RChar(short id, short left, short right, byte[] b) {
		this(id);
		this.setLeft(left);
		this.setRight(right);
		this.setValue(b);
	...
	public boolean equals(Object arg) {
		if (arg == null || arg.getClass() != RChar.class) {
			return false;
		}
